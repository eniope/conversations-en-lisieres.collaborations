...
draft: false
publish: true
description: "L'instrument où les autres s'accordent, ou choisissent de ne pas s'accorder. En gestation, sous forme de texte : l'enjeu des données interopérables dans la conception d'un modèle."
---
...
## L'enjeu des données interopérables
