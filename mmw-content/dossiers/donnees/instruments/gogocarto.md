...
draft: false
publish: true
description: "L'instrument qui recense : qui, quels acteurs et initiatives, reliés comment au territoire. La seule pièce déjà peuplée."
---

# GoGoCarto, l'annuaire-carte de l'enquête

Troisième pièce des [[dossiers/donnees/index|données de ma recherche]], et la seule déjà peuplée. GoGoCarto est une cartographie collaborative structurée : un annuaire vivant d'acteurs et d'initiatives, posé sur une carte, où chaque entrée est décrite par des catégories partagées. Sa question : qui fait quoi, où, et comment chacun se sent relié à un territoire.

Contrairement à la frise (le quand) et à la carte-récit (le où d'un parcours), GoGoCarto recense et structure. Elle produit des données interopérables, pensées pour circuler et se combiner, ce qui la relie directement à la [[dossiers/donnees/instruments/modele-de-donnees|question du modèle de données]].
...
<iframe src="https://cooplab.gogocarto.fr/" width="100%" height="640" frameborder="0" style="border:1px solid #d0d7de; border-radius:8px" title="GoGoCarto, la lisière Sud Berry / Creuse" loading="lazy"></iframe>

Si la carte ne s'affiche pas ici, [l'ouvrir en pleine page](https://cooplab.gogocarto.fr/).
